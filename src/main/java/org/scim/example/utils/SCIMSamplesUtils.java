...
* under the License.
*/
package org.scim.example.utils;
...
//                                                  File.separator + "security" + File.separator + "wso2carbon.jks";
    ...
    public static final String IS_HOME = "." + File.separator;
    public static final String TRUST_STORE_PATH = IS_HOME + "wso2carbon.jks";
    ...
    public static String userNameToCreateUser = "Hasini@TG.com";
    public static String userNameToUpdateUser = "HasiniG11";
